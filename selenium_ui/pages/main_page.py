...
class MainPage():
    ...
    def sing_in(self):
        return Element(self.driver, locator=self.locators.sing_in)

    def search_bar(self):
        return Element(self.driver, locator=self.locators.search_bar)

    def search_button(self):
        return Element(self.driver, locator=self.locators.search_button)
    
    def fish_section(self): 
        return Element(self.driver, locator=self.locators.fish_section)
    
    def firts_element_search(self):
        return Element(self.driver, locator=self.locators.firts_element_search)
    
    def add_cart(self):
        return Element(self.driver, locator=self.locators.add_cart)
    
    def dogs_sections(self):
        return Element(self.driver, locator=self.locators.dogs_section)
    
    def cats_section(self): 
        return Element(self.driver, locator=self.locators.cats_section)